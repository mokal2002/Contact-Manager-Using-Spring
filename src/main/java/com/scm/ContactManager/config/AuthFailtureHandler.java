...
// @Component
// public class AuthFaliuerHandler implements AuthenticationFailureHandler {
...
//         if (exception instanceof DisabledException) {
//             HttpSession session = request.getSession();
//             session.setAttribute("message", Message.builder().content("User Account is Not Enabled or Disabled please Verify Email.").type(MessageType.red).build());;
//             response.sendRedirect("/login");
//         }else{
